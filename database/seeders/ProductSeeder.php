    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'price' => 115.00,
                'body' => 'Bir shot espresso genellikle zihni uyandırırmak içindir ve bu nedenle birinin shot espressosu olmak, onun ruh halini bir ton yükselttiğiniz anlamına gelir.  Copper olarak sizin için asansör etkisinde robusta ve arabica\'nın kalitesini harmanlayarak yoğun bir tat ve güçlü içim kahve deneyimi sunar. Kafeinsiz karakteristik tatları sevenler için mükemmel seçim.',
                'category' => 'Sıcak İçecekler'
            ],
            [
            ...
            [
                ...
                'price' => 115.00,
                'body' => 'Bir shot espresso genellikle zihni uyandırırması içindir,bu nedenle birinin shot espressosu olmak, onun ruh halini bir ton yükselttiğiniz anlamına gelir.  Copper Coffee Shop  sizin için asansör etkisinde robusta ve arabica\'nın kalitesini harmanlayarak yoğun bir tat ve güçlü içim kahve deneyimi sunar. Karakteristik tatları sevenler için mükemmel seçim. Lungo sevenler için espresso yanında sıcak su servis ediyoruz istediğiniz yumuşaklığa karar verebilmeniz için',
                'category' => 'Sıcak İçecekler'
            ],
            [
            ...
            [
                ...
                'title' => 'Filtre Kahve',
                'price' => 120.00,
                'body' => 'Filtre kahve, öğütülmüş kahve çekirdeklerinin sıcak suyla buluşturulup demlenmesi sonucu elde edilen kahve çeşididir. Genel olarak farklı tipte ürün skalaları fanatiklerini de oluşturmuştur. Copper olarak karakteristik ve gövdeli kahve deneyimi sunarken kahve adına dip not bilgiler vermek gerekirse yağ yakıcıdır, diyabet kontrolüne destek verir, Alzheimer önleyici olup tam bir antioksidan deposudur demek yeterli olur şimdilik.',
                'category' => 'Sıcak İçecekler'
            ],
            [
